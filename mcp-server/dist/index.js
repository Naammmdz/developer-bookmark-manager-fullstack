            ...
            try {
                switch (name) {
                    ...
                    case 'get_bookmark':
                        ...
                        const bookmark = await this.apiClient.getBookmark(args.id);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'create_bookmark':
                        ...
                        const newBookmark = await this.apiClient.createBookmark(args);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'delete_bookmark':
                        ...
                        await this.apiClient.deleteBookmark(args.id);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'create_collection':
                        ...
                        const newCollection = await this.apiClient.createCollection(args);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'search_bookmarks':
                        ...
                        const searchResults = await this.apiClient.searchBookmarks(args.query);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'get_codeblock':
                        ...
                        const codeBlock = await this.apiClient.getCodeBlock(args.id);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'create_codeblock':
                        ...
                        const newCodeBlock = await this.apiClient.createCodeBlock(args);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'update_codeblock':
                        ...
                        const { id: codeBlockId, ...codeBlockUpdateData } = args;
                    ...
                    case 'delete_codeblock':
                        ...
                        await this.apiClient.deleteCodeBlock(args.id);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'toggle_favorite_codeblock':
                        ...
                        const toggledCodeBlock = await this.apiClient.toggleFavoriteCodeBlock(args.id);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'search_codeblocks':
                        ...
                        const codeBlockSearchResults = await this.apiClient.searchCodeBlocks(args.query, args.collection);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'get_codeblocks_by_collection':
                        ...
                        const codeBlocksByCollection = await this.apiClient.getCodeBlocksByCollection(args.collection);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'get_codeblocks_by_language':
                        ...
                        const codeBlocksByLanguage = await this.apiClient.getCodeBlocksByLanguage(args.language);
                        return {
                            content: [
                                {
                                    type: 'text',
